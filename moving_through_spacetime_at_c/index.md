...
Not to beat a dead horse, but we can now see yet another reason why Greene's description doesn't make a lot of sense. A ray of light travels at the speed of light. Therefore if you plug in to the formula, you get Δs=0. So in Greene's verbal depiction, we're all "moving through spacetime" at c, except for beams of light, which are all "moving through spacetime" at a speed of ... what? Zero? A vector describing this type of motion has a "magnitude" of zero in relativity, which is why you can't normalize it in the way Greene has in mind. The difficulty here arises because Greene wants to normalize all his velocity vectors, but a ray of light has a velocity vector that has a "length" of zero. (At best you can call Δs/Δt an [indeterminate form](https://en.wikipedia.org/wiki/Indeterminate_form), like 0/0.)
